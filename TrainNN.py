...
IM_WIDTH, IM_HEIGHT = 224, 224 #fixed size for VGG16
EPOCHS = 5
BAT_SIZE = 10
FC_SIZE = 1024
NB_V16_LAYERS_TO_FREEZE = 172
...
def setup_to_finetune(model):
  """Freeze the bottom NB_V16_LAYERS and retrain the remaining top layers.
  note: NB_V16_LAYERS corresponds to the top 2 inception blocks in the inceptionv3 arch
  Args:
    model: keras model
  """
  for layer in model.layers[:NB_V16_LAYERS_TO_FREEZE]:
     layer.trainable = False
  for layer in model.layers[NB_V16_LAYERS_TO_FREEZE:]:
